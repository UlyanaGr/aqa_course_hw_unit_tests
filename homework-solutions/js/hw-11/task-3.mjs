...
class Developer extends Employee {
  ...
  addProgrammingLanguage(language) {
    if (typeof language != 'string') {
      throw new Error('Language value is not a String');
    }

    if (language.length === 0) {
      throw new Error('Language value is empty');
    }
...
class Designer extends Employee {
  ...
  addDesignTool(tool) {
    if (typeof tool != 'string') {
      throw new Error('Tool value is not a String');
    }

    if (tool.length === 0) {
      throw new Error('Tool value is empty');
    }
...
class Company {
  ...
  addEmployee(newEmployee) {
    ...
    if (this.#employees.filter((employee) => employee.getFullName() === newEmployee.getFullName()).length > 0) {
